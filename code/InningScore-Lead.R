setwd("C:/Users/Jaewon/Desktop/Academic/9(Fall 2015)/Research - Baseball Analytics/Inning Score/")
library(pitchRx)
library(XML2R)
library(dplyr)
...
valid_xml <- XML2Obs(paste0(valid_gid))
...
write.csv(result, "result_test.csv")
# total: number of games has lead
write.csv(total, "total_test.csv")
